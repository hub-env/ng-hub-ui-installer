...
export const LIBRARY_PACKAGES: Record<string, PackageMetadata> = {
	...
	'action-sheet': { packageName: 'ng-hub-ui-action-sheet', version: '^22.1.0' },
	breadcrumbs: { packageName: 'ng-hub-ui-breadcrumbs', version: '^22.7.0' },
	buttons: {
	...
	ds: { packageName: 'ng-hub-ui-ds', version: '^22.9.3' },
	forms: {
		packageName: 'ng-hub-ui-forms',
		version: '^22.33.2',
		dependencies: ['utils']
	},
	history: { packageName: 'ng-hub-ui-history', version: '^22.0.4' },
	icons: { packageName: 'ng-hub-ui-icons', version: '^22.3.0' },
	loading: {
	...
	skeleton: { packageName: 'ng-hub-ui-skeleton', version: '^22.3.1' },
	sortable: {
	...
	utils: { packageName: 'ng-hub-ui-utils', version: '^22.14.0' }
};
